...
Terraform is an infrastructure as code tool to assist in deployment. The HAProxy charm provides a Terraform module for deployment. The autogenerated documentation is located at `terraform/product/README.md` in the repository, and documents the module, resources, inputs, and outputs.
